...
import com.blueyonder.loginservice.filter.JwtAuthFilter;
	   ...
	   public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
	        return http.csrf(csrf -> csrf.disable())
	        		.authorizeHttpRequests(requests -> requests
	        			    .requestMatchers("/auth/**", "/authenticate", "/swagger-ui/**", "/swagger-ui.html", "/v3/api-docs/**").permitAll())
	        		 // Add this line to properly chain the authorization rules
